...
const flagTexture = textureLoader.load("/textures/nz1.png")
...
const material = new THREE.ShaderMaterial(
    ...
    gui.add(material.uniforms.uFrequency.value, "x").min(0).max(20).step(0.001).name("waves X")
    gui.add(material.uniforms.uFrequency.value, "y").min(0).max(20).step(0.001).name("waves Y")
